...
FIXTURE_SCHEMA = {
    ...
    "portrait-v1": {
        ...
        "portrait-graph": PORTRAIT_V1_BASE + "portrait.schema.json#/$defs/graph",
        "portrait-claim": PORTRAIT_V1_BASE + "portrait.schema.json#/$defs/claim",
        "portrait-completion": PORTRAIT_V1_BASE + "portrait.schema.json#/$defs/completion",
        "portrait-failure": PORTRAIT_V1_BASE + "portrait.schema.json#/$defs/failure",
        "portrait-download": PORTRAIT_V1_BASE + "portrait.schema.json#/$defs/download",
    },
    "portrait-v2": {
        "portrait-response": PORTRAIT_V2_BASE + "portrait.schema.json#/$defs/response",
        "portrait-request": PORTRAIT_V2_BASE + "portrait.schema.json#/$defs/generationRequest",
        "portrait-graph": PORTRAIT_V2_BASE + "portrait.schema.json#/$defs/graph",
        "portrait-claim": PORTRAIT_V2_BASE + "portrait.schema.json#/$defs/claim",
        "portrait-completion": PORTRAIT_V2_BASE + "portrait.schema.json#/$defs/completion",
        "portrait-failure": PORTRAIT_V2_BASE + "portrait.schema.json#/$defs/failure",
        "portrait-download": PORTRAIT_V2_BASE + "portrait.schema.json#/$defs/download",
    },
    "portrait-mesh-v2": {
        "claim": PORTRAIT_MESH_V2_BASE + "claim.schema.json",
        "completion": PORTRAIT_MESH_V2_BASE + "completion.schema.json",
        "failure": PORTRAIT_MESH_V2_BASE + "failure.schema.json",
        "program": PORTRAIT_MESH_V2_BASE + "program.schema.json",
        "model": PORTRAIT_MESH_V2_BASE + "model.schema.json",
        "automation-request": PORTRAIT_MESH_V2_BASE + "automation-request.schema.json",
        "automation-response": PORTRAIT_MESH_V2_BASE + "automation-response.schema.json",
        "explorer-response": PORTRAIT_MESH_V2_BASE + "explorer-response.schema.json",
        "explorer-download": PORTRAIT_MESH_V2_BASE + "explorer-download.schema.json",
    },
    "geocoder-v2": {
...
def check_openapi(package: Path, registry: Registry) -> list[str]:
    ...
    def local_contract_handler(uri: str):
        ...
        parsed = urlparse(uri)
        if parsed.netloc in ("patternlike.app", "patternlike.dev") and parsed.path.startswith("/contracts/"):
...
def main() -> int:
    ...
    errors += validate_package(registry, "portrait-v2", PORTRAIT_V2, set())

...
Dated publication: [September 23 release map](snapshots/2026-09-23-release-28fd3d6/patternlike-source-mindmap.md), [claim/evidence index](snapshots/2026-09-23-release-28fd3d6/source-evidence.md), and [complete source identity](snapshots/2026-09-23-release-28fd3d6/source-snapshot.json), captured at `9475393541ba5dcad04198b2d32cfe880999615d` after integrating main's `28fd3d642761cc59b6036b4cdc55daa8bd11876f`. All consumed inputs were clean. This publication includes Pattern writer 1.0.5 and cumulative correction history, and records the repaired CI success line and its regression coverage. At capture, checks succeeded for eight branches, 49 topics, 172 claims, and 943 evidence selectors across 251 referenced files, used in 995 claim citations.

Earlier September 23 publication: [map reconciled with c31cf41](snapshots/2026-09-23-main-c31cf41/patternlike-source-mindmap.md), [claim/evidence index](snapshots/2026-09-23-main-c31cf41/source-evidence.md), and [complete source identity](snapshots/2026-09-23-main-c31cf41/source-snapshot.json), captured at `d53dd4d16a48c1d024112c14b7a63bce7702adde`. Its AppShell navigation selector reflects the removal of milestone labels, and its receipt records the changed Onboarding source. That capture verified 938 evidence selectors across 249 files, used in 991 claim citations. It predates the Pattern writer and CI summary changes and remains unchanged as a dated reference.

Original September 23 publication: [map](snapshots/2026-09-23-head-77c6c00/patternlike-source-mindmap.md), [claim/evidence index](snapshots/2026-09-23-head-77c6c00/source-evidence.md), and [complete source identity](snapshots/2026-09-23-head-77c6c00/source-snapshot.json), captured against `77c6c0012cf3c8ff506c63ea422fa7830865f289` with `map.json` as the only dirty consumed input. Its check passed against that base during import. It is retained unchanged as a dated reference and does not match the current checkout.

Previous publication: [September 9 map](snapshots/2026-09-09-slice-1/patternlike-source-mindmap.md) (42 topics, 97 claims, 201 evidence selectors across 119 referenced files). Its definition, a tooling input, and several cited sources have changed since, so it no longer matches the current checkout; retain it as a dated reference. Older captures remain immutable.
...
The one-off September 8 static-source audit of the pre-maintenance mind map (`patternlike-map-verification-c98ecf0.md`, formerly at the repository root) predates this maintained map. It was removed on 2026-09-23 and remains in Git history.

...
Dated publication: [September 23 map](snapshots/2026-09-23-head-77c6c00/patternlike-source-mindmap.md), [claim/evidence index](snapshots/2026-09-23-head-77c6c00/source-evidence.md), and [complete source identity](snapshots/2026-09-23-head-77c6c00/source-snapshot.json), captured against main at `77c6c0012cf3c8ff506c63ea422fa7830865f289` with `map.json` as the only dirty consumed input. At capture, checks succeeded for eight branches, 49 topics, 172 claims, and 938 evidence selectors across 249 referenced files.

...
Dated publication: [September 23 map, reconciled with main](snapshots/2026-09-23-main-c31cf41/patternlike-source-mindmap.md), [claim/evidence index](snapshots/2026-09-23-main-c31cf41/source-evidence.md), and [complete source identity](snapshots/2026-09-23-main-c31cf41/source-snapshot.json), captured at `d53dd4d16a48c1d024112c14b7a63bce7702adde` after importing the refresh onto main's `c31cf41877dbd517b0b772619dc1647e7e3df166`. All consumed inputs were clean. The AppShell navigation selector reflects main's removal of milestone labels; the refreshed receipt also records the changed Onboarding source. At capture, checks succeeded for eight branches, 49 topics, 172 claims, and 938 evidence selectors across 249 referenced files, used in 991 claim citations.

Original September 23 publication: [map](snapshots/2026-09-23-head-77c6c00/patternlike-source-mindmap.md), [claim/evidence index](snapshots/2026-09-23-head-77c6c00/source-evidence.md), and [complete source identity](snapshots/2026-09-23-head-77c6c00/source-snapshot.json), captured against `77c6c0012cf3c8ff506c63ea422fa7830865f289` with `map.json` as the only dirty consumed input. Its check passed against that base during import. It is retained unchanged as a dated reference; its definition and two referenced source files differ from the reconciled publication.

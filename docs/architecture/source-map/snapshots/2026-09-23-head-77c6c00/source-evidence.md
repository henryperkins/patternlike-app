...
- [Each delivery claims its stage before a planner, writer, or semantic verifier pass, and commands cap attempts at 2, 3, and 2\. An invalid plan retries the planner while planner attempts remain and otherwise fails as plan\_invalid; candidate\-validation, semantic, and correctable publication\-safety failures return to the writer with a correction document while writer attempts remain\.](patternlike-source-mindmap.md#claim-leaf-plan-write-and-verify-1) — [evidence-b4-execute-claim-stage](#evidence-evidence-b4-execute-claim-stage) [evidence-b4-enqueue-attempt-caps](#evidence-evidence-b4-enqueue-attempt-caps) [evidence-b4-execute-plan-retry](#evidence-evidence-b4-execute-plan-retry) [evidence-b4-execute-deterministic-correction](#evidence-evidence-b4-execute-deterministic-correction) [evidence-b4-execute-semantic-correction](#evidence-evidence-b4-execute-semantic-correction) [evidence-b4-execute-safety-correction](#evidence-evidence-b4-execute-safety-correction)
...
- [scripts/ci\-local\.sh prints its ALL STEPS PASSED line with a mis\-encoded dash, while parseCiSummary in release\-evidence\.mjs accepts only a real em dash, so it does not accept the gate's actual success line\. A receipt from a passing run then fails with gate\_summary\_incomplete, which also blocks reconciliation; the release\-evidence test uses a hand\-written summary with the real dash\.](patternlike-source-mindmap.md#claim-leaf-release-assurance-tooling-5) — [evidence-b8-ci-local-misencoded-success](#evidence-evidence-b8-ci-local-misencoded-success) [evidence-b8-parse-ci-summary-em-dash](#evidence-evidence-b8-parse-ci-summary-em-dash) [evidence-b8-receipt-summary-from-parser](#evidence-evidence-b8-receipt-summary-from-parser) [evidence-b8-gate-summary-incomplete](#evidence-evidence-b8-gate-summary-incomplete) [evidence-b8-reconciliation-requires-verified-gate](#evidence-evidence-b8-reconciliation-requires-verified-gate) [evidence-b8-release-evidence-test-summary](#evidence-evidence-b8-release-evidence-test-summary)
...
Current source — [apps/api/src/services/pattern\-execute\.ts](../../../../../apps/api/src/services/pattern-execute.ts#L1945), lines 1945–1945.
...
Current source — [apps/web/src/components/Onboarding\.tsx](../../../../../apps/web/src/components/Onboarding.tsx#L629), lines 629–629.

<a id="evidence-evidence-b1-onboarding-fresh-submit"></a>
## evidence-b1-onboarding-fresh-submit

Current source — [apps/web/src/components/Onboarding\.tsx](../../../../../apps/web/src/components/Onboarding.tsx#L723), lines 723–723.
...
Current source — [apps/web/src/components/Onboarding\.tsx](../../../../../apps/web/src/components/Onboarding.tsx#L563), lines 563–563.
...
Current source — [apps/api/src/services/pattern\-execute\.ts](../../../../../apps/api/src/services/pattern-execute.ts#L1109), lines 1109–1117.
...
Current source — [apps/api/src/services/pattern\-execute\.ts](../../../../../apps/api/src/services/pattern-execute.ts#L1090), lines 1090–1091.

<a id="evidence-evidence-b4-execute-feature-set"></a>
## evidence-b4-execute-feature-set

Current source — [apps/api/src/services/pattern\-execute\.ts](../../../../../apps/api/src/services/pattern-execute.ts#L1100), lines 1100–1101.
...
Current source — [apps/api/src/services/pattern\-execute\.ts](../../../../../apps/api/src/services/pattern-execute.ts#L1109), lines 1109–1109.

<a id="evidence-evidence-b4-execute-planner-input"></a>
## evidence-b4-execute-planner-input

Current source — [apps/api/src/services/pattern\-execute\.ts](../../../../../apps/api/src/services/pattern-execute.ts#L1230), lines 1230–1230.
...
Current source — [apps/api/src/services/pattern\-execute\.ts](../../../../../apps/api/src/services/pattern-execute.ts#L824), lines 824–824.

<a id="evidence-evidence-b4-execute-consent-gate"></a>
## evidence-b4-execute-consent-gate

Current source — [apps/api/src/services/pattern\-execute\.ts](../../../../../apps/api/src/services/pattern-execute.ts#L830), lines 830–830.

<a id="evidence-evidence-b4-execute-chart-gate"></a>
## evidence-b4-execute-chart-gate

Current source — [apps/api/src/services/pattern\-execute\.ts](../../../../../apps/api/src/services/pattern-execute.ts#L836), lines 836–836.

<a id="evidence-evidence-b4-execute-claim-owner"></a>
## evidence-b4-execute-claim-owner

Current source — [apps/api/src/services/pattern\-execute\.ts](../../../../../apps/api/src/services/pattern-execute.ts#L871), lines 871–871.

<a id="evidence-evidence-b4-execute-claim-stage"></a>
## evidence-b4-execute-claim-stage

Current source — [apps/api/src/services/pattern\-execute\.ts](../../../../../apps/api/src/services/pattern-execute.ts#L1025), lines 1025–1025.
...
Current source — [apps/api/src/services/pattern\-execute\.ts](../../../../../apps/api/src/services/pattern-execute.ts#L1276), lines 1276–1288.

<a id="evidence-evidence-b4-execute-deterministic-correction"></a>
## evidence-b4-execute-deterministic-correction

Current source — [apps/api/src/services/pattern\-execute\.ts](../../../../../apps/api/src/services/pattern-execute.ts#L1436), lines 1436–1436.

<a id="evidence-evidence-b4-execute-semantic-correction"></a>
## evidence-b4-execute-semantic-correction

Current source — [apps/api/src/services/pattern\-execute\.ts](../../../../../apps/api/src/services/pattern-execute.ts#L1617), lines 1617–1617.

<a id="evidence-evidence-b4-execute-safety-correction"></a>
## evidence-b4-execute-safety-correction

Current source — [apps/api/src/services/pattern\-execute\.ts](../../../../../apps/api/src/services/pattern-execute.ts#L1688), lines 1688–1689.

<a id="evidence-evidence-apps-api-services-pattern-execute-ts-2"></a>
## evidence-apps-api-services-pattern-execute-ts-2

Current source — [apps/api/src/services/pattern\-execute\.ts](../../../../../apps/api/src/services/pattern-execute.ts#L1267), lines 1267–1267.

<a id="evidence-evidence-apps-api-services-pattern-execute-ts-7"></a>
## evidence-apps-api-services-pattern-execute-ts-7

Current source — [apps/api/src/services/pattern\-execute\.ts](../../../../../apps/api/src/services/pattern-execute.ts#L1418), lines 1418–1418.

<a id="evidence-evidence-b4-execute-publication-proof"></a>
## evidence-b4-execute-publication-proof

Current source — [apps/api/src/services/pattern\-execute\.ts](../../../../../apps/api/src/services/pattern-execute.ts#L1662), lines 1662–1662.
...
Current source — [apps/api/src/services/pattern\-execute\.ts](../../../../../apps/api/src/services/pattern-execute.ts#L1912), lines 1912–1912.
...
Current source — [apps/api/src/services/pattern\-execute\.ts](../../../../../apps/api/src/services/pattern-execute.ts#L1788), lines 1788–1788.
...
Current source — [apps/api/src/services/pattern\-execute\.ts](../../../../../apps/api/src/services/pattern-execute.ts#L1653), lines 1653–1653.
...
Current source — [apps/api/src/services/pattern\-execute\.ts](../../../../../apps/api/src/services/pattern-execute.ts#L817), lines 817–820.

<a id="evidence-evidence-b6-pattern-cancel-transition"></a>
## evidence-b6-pattern-cancel-transition

Current source — [apps/api/src/services/pattern\-execute\.ts](../../../../../apps/api/src/services/pattern-execute.ts#L1056), lines 1056–1061.
...
Current source — [apps/api/src/services/pattern\-execute\.ts](../../../../../apps/api/src/services/pattern-execute.ts#L1233), lines 1233–1233.

<a id="evidence-evidence-b6-pattern-verifier-pass"></a>
## evidence-b6-pattern-verifier-pass

Current source — [apps/api/src/services/pattern\-execute\.ts](../../../../../apps/api/src/services/pattern-execute.ts#L1542), lines 1542–1542.
...
Current source — [apps/api/src/services/pattern\-execute\.ts](../../../../../apps/api/src/services/pattern-execute.ts#L1907), lines 1907–1912.
...
<a id="evidence-evidence-b8-ci-local-misencoded-success"></a>
## evidence-b8-ci-local-misencoded-success
...
Current source — [scripts/pattern\-release/release\-evidence\.mjs](../../../../../scripts/pattern-release/release-evidence.mjs#L103), lines 103–103.

<a id="evidence-evidence-b8-receipt-summary-from-parser"></a>
## evidence-b8-receipt-summary-from-parser

Current source — [scripts/pattern\-release/release\-evidence\.mjs](../../../../../scripts/pattern-release/release-evidence.mjs#L209), lines 209–209.
...
<a id="evidence-evidence-b8-release-evidence-test-summary"></a>
## evidence-b8-release-evidence-test-summary

Current source — [scripts/pattern\-release/release\-evidence\.test\.mjs](../../../../../scripts/pattern-release/release-evidence.test.mjs#L28), lines 28–28.

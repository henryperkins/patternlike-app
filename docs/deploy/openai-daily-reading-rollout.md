...
> ordered enablement sequence was recorded in
> `2026-08-27-codex-reader-rollout.md` (removed; in Git history).
>
...
`2026-08-15-openai-pattern-adapter.md` (removed; in Git history), and it is a

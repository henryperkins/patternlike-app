...
| Historical migration inventory (2026-08-25 query) | The queried production ledger was at `0015`, with nothing pending then | `0015_ontology_pipeline_regression_evidence.sql` applied `2026-08-25 00:59:51`, ahead of the Worker that read it. `0013` / `0014` were already applied. |

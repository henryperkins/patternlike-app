...
> snapshot, not a refreshed status audit or current production evidence. It was
> preserved from commit `980ed05832c9c167a9227a9cff61920b947737ae` at its
> original path, including the 2026-08-12 correction. See the
> [preservation index](./2026-09-07-historical-audit-preservation.md) for
> provenance, original-body verification, and supersession context.

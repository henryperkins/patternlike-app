> **Historical preservation notice — 2026-09-07.** This report is a dated
> snapshot, not refreshed research, a current status audit, or current
> production evidence. It was recovered from the untracked-file tree stored as
> the third parent of immutable stash `17f1901676a5eae22b674c3d28f95d662220accf`.
> See the [preservation index](./2026-09-07-historical-audit-preservation.md)
> for provenance, original-body verification, and authorship limits.

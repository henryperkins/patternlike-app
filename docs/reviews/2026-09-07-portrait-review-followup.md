...
**Current backlog:** The [consolidated remaining priorities](2026-09-07-portrait-remaining-priorities.md) incorporate the three subsequently supplied Cursor review extracts and fresh targeted verification. They supersede the four priorities below. The original corrections remain valid; native Back from sky is a separately reproduced defect, and the standalone phone return differs from the account's sticky return.

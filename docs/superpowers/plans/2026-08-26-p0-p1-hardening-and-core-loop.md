...
- Land and apply each schema-only migration before merging code that queries it. Workers Builds deploys merged Worker code automatically and does not wait for D1 migrations.

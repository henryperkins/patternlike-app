...
| 2 | Verification expansion withdrawn | Existing commands and focused tests; no new implementation or dependency |
...
**Decision:** The user withdrew the proposed release-preflight expansion on 2026-09-09 before implementation.

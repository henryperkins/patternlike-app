...
| 2 | [Verification expansion withdrawn](../specs/2026-09-08-release-preflight-design.md) | Existing commands and focused tests; no new implementation or dependency |
...
**Decision:** The user withdrew the proposed release-preflight expansion on 2026-09-09 before implementation. See the [superseding decision](../specs/2026-09-08-release-preflight-design.md).

...
This document supersedes only the **Your Pattern** portions of `2026-08-13-your-pattern-time-travel-v02-design.md` (removed; in Git history) once the AI rollout reaches the applicable cohort.

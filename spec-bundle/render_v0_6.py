"""Render the v0.6 specification Markdown to DOCX and PDF.
...
STEM = "pattern_like_astrology_app_product_platform_spec_v0.6"
...
def write_pdf(blocks) -> None:
    ...
    def furniture(canvas, document):
        ...
        canvas.drawString(0.9 * inch, 0.6 * inch, "Pattern/Like — Product, UX, Data, and Platform Design Specification v0.6")
...
def write_manifest() -> None:
    ...
    manifest = {
        "//": [
            ...
            "Markdown by spec-bundle/render_v0_6.py - regenerate rather than edit them.",
        ],
        "version": "0.6",
        "date": "2026-08-16",
        "supersedes": "0.5",
        ...
        "carried_forward_unchanged": {
            ...
            "pattern_like_astrology_app_product_platform_spec_v0.2.md": "sections neither v0.5 nor v0.6 restates remain in force as published",
